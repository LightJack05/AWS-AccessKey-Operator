...
*/}}
{{- define "aws-accesskey-operator.name" -}}
...
*/}}
{{- define "aws-accesskey-operator.fullname" -}}
...
*/}}
{{- define "aws-accesskey-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "aws-accesskey-operator.resourceName" -}}
{{- $fullname := include "aws-accesskey-operator.fullname" .context }}
{{- $suffix := .suffix }}
